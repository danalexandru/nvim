...
let s:green_alt  = '#16a085'

" let s:bg             = '#282c34'
let s:bg             = '#222b2e'
let s:bg_alt         = '#222b2e'
" let s:bg_highlight   = '#2E323C'
let s:bg_highlight   = '#141a1b'
let s:bg_popup       = '#263034'
...
let s:fg_linenr    = s:green_alt


let s:highlight       = s:green_alt
let s:highlight_color = s:base0

" let s:tag    = color#Mix(s:blue, s:cyan)
let s:tag    = s:green_alt

let s:diff_info_fg  = s:green_alt
...
let s:diff_add_fg  = s:green
let s:diff_add_fg0 = s:green
let s:diff_add_bg0 = '#506d5b'
let s:diff_add_bg1 = '#acf2bd'
let s:diff_add_bg2 = '#acf2bd'

let s:gh_danger_fg  = s:red
let s:gh_danger_fg0 = s:red
let s:gh_danger_bg0 = '#FBB0B9' 
let s:gh_danger_bg1 = '#FBB0B9'
let s:gh_danger_bg2 = '#FBB0B9'
" }}}
" General UI                                                                 {{{
...
call s:_('NormalPopupPrompt', s:base7,        s:bg_popup, 'bold')
...
call s:_('CursorLine',       '',          s:bg_highlight, 'none')
call s:_('CursorColumn',     '',          s:bg_highlight, 'none')
call s:_('CursorLineNr',     s:highlight, s:bg_highlight, 'none')
call s:_('LineNr',           s:fg_linenr, s:bg_widget,    'none')
" call s:_('LineNr',           s:fg_linenr, '',    'none')
...
call s:_('InclineNormal',   s:fg)
call s:_('InclineNormalNC', s:fg)
...
if has("nvim") && get(g:, 'matcha_one_terminal_colors', v:false)
...
call s:_('Macro',                s:green_alt, '',           'bold')
call s:_('Define',               s:green_alt, '',           'bold')
call s:_('PreCondit',            s:magenta, '',        'bold')
call s:_('Include',              s:green_alt, '',           'bold')

call s:_('Repeat',               s:green_alt, '',        '')
call s:_('Keyword',              s:green_alt, '',        '')
call s:_('Statement',            s:green_alt, '',        'none')
call s:_('Label',                s:green_alt, '',        '')

call s:_('Operator',             s:green_alt, '',        '')

call s:_('Constant',             s:violet, '',        'bold')
call s:_('ConstantBuiltin',      s:magenta, '',       'bold')

call s:_('Conditional',          s:green_alt, '',        '')
...
call s:_('Delimiter',            s:green_alt,  '',        'none')
...
call s:_('Identifier',           s:magenta, '',        'none')
call s:_('Argument',             s:magenta, '',        'none')
call s:_('Variable',             s:magenta, '',        'none')
call s:_('VariableBuiltin',      s:magenta, '',        'none')
...
call s:_('StorageClass',         s:green_alt, '',        'none')
call s:_('Class',                s:green_alt, '',        'none')
call s:_('Structure',            s:green_alt, '',        'none')
call s:_('Typedef',              s:green_alt, '',        'none')
...
call s:_('TreesitterContextLineNumber', s:fg_linenr, s:bg_popup)
...
call s:_('illuminatedWord', '', s:bg_highlight)
