...
let s:palette.special   = {'dark': "#E7C547",  'light': "#E6B673",  'mirage': "#FFC44C"}
...
" !!!
exe "hi! VertSplit"     .s:fg_guide       .s:bg_none        .s:fmt_none
...
exe "hi! StatusLine"    .s:fg_guide       .s:bg_panel       .s:fmt_none
...
"   TabLineSel"
" !!!
exe "hi! Title"         .s:fg_special     .s:bg_none        .s:fmt_none
